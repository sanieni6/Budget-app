...
RSpec.describe 'Integrations tests for categories/show', type: :feature do
  before(:each) do
  ...
  describe 'GET /show' do
    ...
    it 'should display a link to create a new Transaction' do
      expect(page).to have_link('New Transaction', href: new_group_operation_path(@group))
    end
  end
end
